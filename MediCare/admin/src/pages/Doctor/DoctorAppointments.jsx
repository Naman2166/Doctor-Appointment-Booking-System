...
const DoctorAppointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border border-gray-300 rounded-xl text-sm max-h-[80vh] min-h-[80vh] overflow-y-scroll'>
 ...
 
         {
          appointments.reverse().map((item,index)=>(                         //we use reverse method to display new appointment on the top 
            <div key={index} className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid sm:grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 py-3 px-6 border-b border-b-gray-300 hover:bg-gray-50'>
