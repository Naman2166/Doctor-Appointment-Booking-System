    ...
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        {appointments.map((item, index) => (              //index of 1st element of 'appointments' array is 0 , then that of 2nd element is 1 ,and so on..
          <div key={index} className='flex flex-col justify-between max-sm:gap-2 sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50 '>               {/* max-sm:gap2 => maximum width is small (ie apply gap-2 property jabtak screen size 'sm' h*/}
